...
from utils.calc_map import get_map, get_coco_map
...
def main(map_out_path, model_path, weights_path):
    ...
    # test_dataset_path = test_dataset_path[4200:5000]
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_path in tqdm(test_dataset_path):
            ...
            if map_vis:
                input_image.save(os.path.join(map_out_path, "images-optional/" + str(image_id) + ".jpg"))
            if method == 'ipsw':
...
if __name__ == '__main__':
    ...
    b_map_out_path = './vgg16_cifar100_fpl_tf2/logs_ipsw_morefc_coco_no_aug'
    b_model_path = './vgg16_cifar100_fpl_tf2/logs_ipsw_morefc_coco_no_aug'
    b_weights_path = './vgg16_cifar100_fpl_tf2/logs_ipsw_morefc_coco_no_aug'
    for i in range(1):
        mop = os.path.sep.join([b_map_out_path, 'w' + str(i + 1), 'map_result'])
