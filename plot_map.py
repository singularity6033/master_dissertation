...
saved_path = ['./plot/fpl_ipsw_vgg11_cifar10.png', './plot/fpl_ipsw_vgg11_cifar100.png',
              './plot/fpl_ipsw_vgg16_cifar10.png',
              './plot/fpl_ipsw_vgg16_cifar100.png']
...
labels_2 = ['subnet-1', 'subnet-2', 'subnt-3', 'subnet-4', 'subnet-5', 'subnet-6', 'subnet-7', 'subnet-8', 'subnet-9',
...
for i in range(2, 4):
    ...
    for j in range(15):
        ...
        map_1[j] = tmp1
        map_2[j] = tmp2
    rects1 = plt.barh([i - 0.2 for i in x2[::-1]], map_1, height=0.4, color='tab:blue', label='IoU = 0.05')
    ...
    plt.savefig(saved_path[i], dpi=300)
# fig.show()
# fig.savefig('./plot/fgl_map.png', dpi=300)
